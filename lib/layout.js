...
(function() {
  ...
  // Only set up the interval at all if this page actually has a
  // countdown on it \u2014 harmless no-op everywhere else.
  if (document.querySelector('.countdown[data-ends-at]')) {
    tick();
